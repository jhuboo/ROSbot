...
class ImageRepeater():
    def __init__(self):
        rospy.Subscriber('raspicam_node/image/compressed', CompressedImage, callback=self.callback, queue_size=1, buff_size=2**18) #the buff_size=2**18 avoids delays due to the queue buffer being too small for images
